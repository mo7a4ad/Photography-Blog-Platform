...
export default function NavBar() {
  return (
    <nav className="navbar navbar-expand-lg border-bottom-1px fixed-top bg-light-black">
      <div className="container  ">
        ...
        >
          <div className=" border border-secondary bg-light-black border-none rounded-pill d-block d-lg-flex  fs-14 p-6 text-secondary fw-bold ">
            <NavLink
              className="bomb text-secondary text-decoration-none rounded-pill"
              to={"/"}
            >
            ...
            <NavLink
              ...
              to={"/whoUs"}
            >
              <div className="main-part py-10 px-20   mb-2 mb-lg-0">من نحن</div>
            </NavLink>
          </div>
